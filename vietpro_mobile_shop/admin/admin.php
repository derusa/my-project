<?php
if(!defined('TEMPLATE')){								//de kiem tra ton tai session chua. phai chay qua index moi vao duoc,khong go duoc truc tiep
...
<body>
	...
	// http://localhost/PHPK156/vietpro_mobile_shop/admin/admin.php?page_layout=add_category
	if(isset($_GET['page_layout'])){
		switch ($_GET['page_layout']) {
			case 'category':
				// hàm gọi tới file trong PHP: include, include_once, require, require_once
