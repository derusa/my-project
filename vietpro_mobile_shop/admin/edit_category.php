...
if (isset($_POST['sbm'])) {
	...
	$sql_name = "SELECT * FROM category WHERE cat_name = '$cat_name' AND cat_id != $cat_id";   
					...
					<div class="col-md-8">
						...
						<form role="form" method="post">
							<div class="form-group">
								...
								<input type="text" name="cat_name" required value="<?php echo $row['cat_name']; ?>" class="form-control"
