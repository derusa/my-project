...
if(!defined('TEMPLATE')){
    ...
    $prd_id = $_GET['prd_id'];
    //required: thuoc tinh html5: phai dien vao moi cho submmit
    //category
    $sql_cat = "SELECT * FROM category ORDER BY cat_id ASC";
    $query_cat = mysqli_query($conn, $sql_cat);
    //product
    $sql_prd = "SELECT * FROM product INNER JOIN category ON product.cat_id = category.cat_id WHERE prd_id = $prd_id";
    $query_prd = mysqli_query($conn, $sql_prd);
    $row = mysqli_fetch_array($query_prd);
    ...
    if(isset( $_POST['sbm'])) {
        ...
        $sql = "UPDATE product SET prd_name = '$prd_name', cat_id = '$cat_id', prd_price = '$prd_price', prd_warranty = '$prd_warranty', prd_accessories = '$prd_accessories', 
        prd_promotion = '$prd_promotion', prd_new = '$prd_new', prd_image = '$prd_image', prd_status = '$prd_status', 
        prd_details = '$prd_details', prd_featured = '$prd_featured' WHERE prd_id = $prd_id ";
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        <form role="form" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="prd_name" required class="form-control" value="<?php echo $row['prd_name'];?>"
                                    placeholder="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="prd_accessories" required value="<?php echo $row['prd_accessories'];?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Khuyến mãi</label>
                                <input type="text" name="prd_promotion" required value="<?php echo $row['prd_promotion'];?>"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Tình trạng</label>
                                <input type="text" name="prd_new" required value="<?php echo $row['prd_new'];?>" type="text"
                                    class="form-control">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br>
                            <div>
                                <img width="130" height="180" src="img/<?php echo $row['prd_image'];?>">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="prd_status" class="form-control">
                                <option <?php if($row['prd_status'] == 1){echo 'selected';} ?> selected value=1>Còn hàng</option>
