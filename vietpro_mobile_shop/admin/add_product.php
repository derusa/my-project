...
if(isset( $_POST['sbm'])) {
    ...
    //insert vao bang product
    $sql_add_prd = "INSERT INTO product(prd_image, cat_id, prd_name, prd_price, prd_warranty, prd_accessories, prd_new, prd_promotion, 
    prd_status, prd_featured, prd_details) VALUES ('$prd_image','$cat_id','$prd_name','$prd_price','$prd_warranty','$prd_accessories','$prd_new','$prd_promotion','$prd_status','$prd_featured','$prd_details')";   //len de trong '' (chi kieu int moi khong can '')
    //dang anh
    move_uploaded_file($prd_image_tmp_name,'img/'.$prd_image);
    mysqli_query($conn, $sql_add_prd);
    //tro lai trang san pham
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">    <!--hien anh khi chon: su dung js mang 3 chieu. chon mot luc nhieu anh-->
