...
if (isset($_POST['sbm'])) {
	...
	$sql_mail = "SELECT * FROM user WHERE user_mail = '$user_mail'";   //$user_mail phai de trong nhay don moi nhan
	$query_mail = mysqli_query($conn, $sql_mail);
	$row = mysqli_num_rows($query_mail);
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-md-8">
						<?php							//hien thi neu co loi trung email hoac pass
